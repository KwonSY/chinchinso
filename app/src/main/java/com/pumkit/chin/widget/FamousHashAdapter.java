...
public class FamousHashAdapter extends BaseAdapter {

    public ArrayList<HashData> listViewItemList = new ArrayList<HashData>() ;

    public FamousHashAdapter() {
    }

    public FamousHashAdapter(ArrayList<HashData> listViewItemList) {
    ...
    public void addItem(String sid, String hash_name) {
